...
;(function($, window, document,undefined){
    ...
    payMask.prototype={
    	...
    	bindEven:function(){
		  ...
		  var canClick = true;
    	  //选择支付方式
		  $('body').on('click','.MaskPaylist > ul > li',function(){
    	    var opt=_this.opt;
		  ...
		  //去支付
		  $('body').on('click','.payTips',function(){
		  	var opt=_this.opt;
		  	console.log('去支付',opt);
		    if (canClick) {
		      canClick = false;
		  ...
		  //关闭支付弹窗
		  $('body').on('click','.CloseMask',function(){
		    _this.hide();
	      });
    	}
    }
